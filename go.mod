...
replace sigs.k8s.io/cluster-api => github.com/giantswarm/cluster-api v0.3.13-gs.0.20211123133141-619f91edddec
...
require (
	...
	k8s.io/apiextensions-apiserver v0.24.0-alpha.1
...
require (
	...
	k8s.io/apiserver v0.24.0-alpha.1 // indirect
